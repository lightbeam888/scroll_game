...
export const GAME_SIZE: Size = { width: 1100, height: 340 }

export const LAND_HEIGHT = 90;
...
export const DINO = {
    statusInfo: {
        [PlayerState.STAND]: {
            frames: [
                {
                    canvasType: CanvasType.TRUMP_STAND,
        ...
        [PlayerState.RUN]: {
            frames: [
                {
                    canvasType: CanvasType.TRUMP_RUN_1,
                    colliderType: ColliderType.DINO_RUN_1,
                },
                {
                    canvasType: CanvasType.TRUMP_RUN_2,
        ...
        [PlayerState.ATTACK]: {
            frames: [
                {
                    canvasType: CanvasType.TRUMP_ATTACK_1,
                    colliderType: ColliderType.DINO_RUN_1,
                },
                {
                    canvasType: CanvasType.TRUMP_ATTACK_2,
                    colliderType: ColliderType.DINO_RUN_2,
                }
            ],
            frameSeconds: 8,
        ...
        [PlayerState.DUCK]: {
            frames: [
                {
                    canvasType: CanvasType.TRUMP_DUCK_1,
                    colliderType: ColliderType.DINO_DUCK_1,
                },
                {
                    canvasType: CanvasType.TRUMP_DUCK_2,
...
export const BIRD = {
    ...
    frameSeconds: 10,
    pos: {x: GAME_SIZE.width, ys: [50 + LAND_HEIGHT, 75+ LAND_HEIGHT, 100 + LAND_HEIGHT]},
    spd: {x: -20, y: 0},
    acc: {x: 0, y: 0},
}
...
export const CACTUS = {
    ...
    types: [
        {
            canvasType: CanvasType.SMALL_CACTUS_1,
            colliderType: ColliderType.CACTUS_SMALL_1,
        },
        {
            canvasType: CanvasType.SMALL_CACTUS_2,
            colliderType: ColliderType.CACTUS_SMALL_2,
        },
        {
            canvasType: CanvasType.SMALL_CACTUS_3,
            colliderType: ColliderType.CACTUS_SMALL_3,
        },
        {
            canvasType: CanvasType.BIG_CACTUS_1,
            colliderType: ColliderType.CACTUS_BIG_1,
        },
        {
            canvasType: CanvasType.BIG_CACTUS_2,
            colliderType: ColliderType.CACTUS_BIG_2,
        },
        {
            canvasType: CanvasType.BIG_CACTUS_3,
            colliderType: ColliderType.CACTUS_BIG_3,
        },
    ],
    pos: {x: GAME_SIZE.width, y: LAND_HEIGHT},
    spd: {x: 0, y: 0},
    acc: {x: 0, y: 0},
}
...
export const CLOUD = {
    ...
    colliderType: ColliderType.NONE,
    pos: {x: GAME_SIZE.width, y: { min: 150 + LAND_HEIGHT, max: 200 + LAND_HEIGHT }},
...
export const MOON = {
    ...
    frameSeconds: 20,
    pos: {x: GAME_SIZE.width, y: 120 + LAND_HEIGHT},
    spd: {x: 600, y: 0}, // horizontal speed for parallax effect
    acc: {x: 0, y: 0},
}
